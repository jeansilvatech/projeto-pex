...
const Products = ()=>{
    return(
        <div className="w-screen flex-wrap flex mt-16 p-9 justify-center items-center gap-2 animate-enter">
            <h2 className="w-full lg:text-4xl text-3xl uppercase font-light text-center">Nossos Produtos</h2>
            {
