...
const About = ()=>{
    return(
        <>
        <DrawerAppBar/>
        <div className='mt-[64px] w-screen h-screen flex justify-start items-center flex-col'>
            <h2 className='text-5xl uppercase m-6'>Quem somos</h2>
                ...
                <div className='w-1/2 mt-6 flex flex-col text-start'>
